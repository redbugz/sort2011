...
$enable_jsonp    = false;
$enable_native   = true;
$valid_url_regex = '/(googleapis.com|familysearch.org|usys.org).*\/(tasks|familytree|reservation|identity|authorities|temple|discussions)/';
...
if ( !$url ) {
  ...
  $fields = (is_array($_POST)) ? http_build_query($_POST) : $_POST;
